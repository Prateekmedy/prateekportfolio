...
class LandingPage extends Component {
    constructor(props){
        super(props);
        console.log(this.props.personalRecord);
    }
                                            ...
                                            <div className="col-12 col-12-small">
                                                <section>
                                                    ...
                                                    <p>
                                                        ...
                                                        <br/>
                                                        <a className="social-icon-anchor" href="https://www.freecodecamp.org/prateekmedy" target="_blank"><span className="social-icon" style={{fontSize: '17px'}}><i className="fab fa-free-code-camp fa-w-16 fa-fw"></i></span>freecodecamp.org/prateekmedy</a>
