...
import PortfolioGallary from './components/PortfolioGalary'
...
class App extends Component {
	...
	render(){
		console.log(this.state.portfolioRecord);
						...
						<section id="header" className="wrapper">
							...
							<nav id="nav">
								<ul>
									...
									<li><a href="index.html#highlights">Portfolio</a></li>
									<li><a href="index.html#footer">Meet Me</a></li>
								</ul>
							</nav>						
						...
						<section id="highlights" className="wrapper style3">
							...
							<div className="container">
								<section className="portfolio section">
									<PortfolioGallary portfolioRecord={this.state.portfolioRecord} />
								</section>
